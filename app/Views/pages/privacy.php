    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="<?= $baseUrl ?>privacy" class="text-blue-800 font-semibold" aria-current="page">Privacy</a>
...
<nav aria-label="Breadcrumb" class="bg-gray-50 py-4">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ol class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li class="text-gray-900 font-medium" aria-current="page">Privacy Policy</li>
        </ol>
    </div>
</nav>
