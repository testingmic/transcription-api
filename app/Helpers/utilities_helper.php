...
if (!function_exists('optimizeRouteSequence')) {
    function optimizeRouteSequence($households, $startLat, $startLon) {
        ...
        while(!empty($remaining)) {
            ...
            foreach($remaining as $index => $household) {
                $distance = calculateDistance(
                    $currentLat, $currentLon,
                    $household['gps_latitude'], $household['gps_longitude']
                );
            ...
            if($nearest) {
                $sequence[] = $nearest['id'];
                $currentLat = $nearest['gps_latitude'];
                $currentLon = $nearest['gps_longitude'];
