...
class FormatRules
{
     ...
     * @param array|bool|float|int|object|string|null $str
     */
    public function valid_array($str = null): bool
    {
        return $this->nonStrictFormatRules->valid_array($str);
    }
    ...
    public function valid_password($str = null): bool
    {
        ...
        return $this->nonStrictFormatRules->valid_password($str);
    }

    /**
     * Checks for a correctly formatted contact number
     *
     * @param array|bool|float|int|object|string|null $str
     */
    public function valid_contact($str = null): bool
    {
        if (! is_string($str)) {
            return false;
        }

        return $this->nonStrictFormatRules->valid_contact($str);
    }
